...
function playGame(playerMove){
  ...
  document.querySelector('.js-moves').innerHTML = `you <img src="./image/${playerMove}-emoji.png" class="move-icons"  alt="${playerMove}-emoji">
    <img src="./image/${computerMove}-emoji.png" class="move-icons" alt="${computerMove}-emoji">
    computer`;
